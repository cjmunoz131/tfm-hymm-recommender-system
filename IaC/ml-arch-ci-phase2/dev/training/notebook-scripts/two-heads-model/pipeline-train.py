...
import os
import pandas as pd # Asegurarnos que pandas esté importado en el main si no lo tenías

def main(df_train, df_valid, df_test, dict_aws):
    print("🚀 Iniciando Orquestador Multi-Task Learning (Retrieval + Calidad)...")
    ...
    # 🌟 NUEVO: Instanciamos ambas funciones de pérdida
    ...
    print("\n" + "="*50)
    print("🔥 INICIANDO BUCLE DE ENTRENAMIENTO MULTI-TASK")
    print("="*50)
    ...
    test_loss = test(model, test_loader, criterion_bce, criterion_mse, device)
    print(f"\n🎉 ¡Entrenamiento finalizado! Loss Total final: {test_loss:.4f}")
